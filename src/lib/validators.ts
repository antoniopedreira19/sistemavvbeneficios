// --- FORMATADORES ROBUSTOS (BLINDADOS CONTRA JSON/ARRAY) ---

export const formatCPF = (value: string | number | string[] | null | undefined) => {
  if (!value) return "";

  // Se for array (JSONB), pega o primeiro item
...
// ALIAS para compatibilidade (alguns arquivos chamam de formatPhone)
export const formatPhone = formatTelefone;

// --- VALIDADORES (LÓGICA MATEMÁTICA) ---
